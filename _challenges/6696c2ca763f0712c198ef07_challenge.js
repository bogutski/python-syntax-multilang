// NAMEEN:
// NAMERU:Количество вхождений элементов в строку
...
Функция должна вернуть строку, в которой будет указано количество вхождений каждого элемента в строку в виде:

`First element: ${el1Count}, second element: ${el2Count}`
...
function numberOfOccurrencesBothEl
INITIALSOLUTIONEND
*/
