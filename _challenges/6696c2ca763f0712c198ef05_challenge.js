// NAMEEN:
// NAMERU:Проверить является ли строка палиндромом
...
/*
INSTRUCTIONRUSTART
Функция `checkStr` принимает строку в качестве параметра и проверяет, является ли эта строка палиндромом.

Строка не может быть пустой и все буквы в нижнем регистре.
