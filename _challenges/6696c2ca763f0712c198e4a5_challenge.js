// NAMEEN:
// NAMERU:Удаление пробелов только в конце строки
...
/*
INSTRUCTIONRUSTART
Напишите функцию `clearString`, которая принимает строку и возвращает ее без пробелов только в конце строки.
